        ...
        <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
            ...
            <li class="nav-item dropdown">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                    ...
                    <span>{{ Auth::guard('admin')->user()->firstName }}</span>
                </a>
                <ul class="dropdown-menu dropdown-user">
                    <li>
                        <div class="user-box">
                            <div class="u-img"><img src="{{ asset('admin/img/profile.jpg') }}" alt="user"></div>
                            <div class="u-text">
                                <h4>{{ Auth::guard('admin')->user()->firstName }}</h4>
                                <p class="text-muted">{{ Auth::guard('admin')->user()->email }}</p>
                                <a href="{{ route('admin.account.view') }}" class="btn btn-rounded btn-danger btn-sm">View Profile</a>
                            </div>
                        </div>
                    </li>
